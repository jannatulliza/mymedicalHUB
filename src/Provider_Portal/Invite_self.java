...
public class Invite_self {
    ...
    public void clickInvite() throws InterruptedException {
        ...
        //self click
        driver.findElement(By.xpath("//*[@id=\"div-refer\"]/div/div[3]/label")).click();
...
//send email
    ...
    public void browserclose() throws InterruptedException {
        ...
        // invite page cross button click

        driver.findElement(By.xpath("//*[@id=\'telemed_invitations_form\']/div[1]/div/div[1]/button")).click();
        Thread.sleep(2000);
